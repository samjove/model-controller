...
generate: controller-gen ## Generate code containing DeepCopy, DeepCopyInto, and DeepCopyObject method implementations.
	"$(CONTROLLER_GEN)" object:year=$(YEAR) paths="./..."
...
KIND_CLUSTER ?= model-controller-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name model-controller-builder
	$(CONTAINER_TOOL) buildx use model-controller-builder
	...
	- $(CONTAINER_TOOL) buildx rm model-controller-builder
	rm Dockerfile.cross
